			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav">
						<li><a href="view_booking.php">Appointments</a></li>
				...
				<div class="col-sm-6">
					<div class="panel panel-primary">
						  <div class="panel-heading">
								<h3 class="panel-title"><i class="fa fa-user-md"></i>Doctor Information</h3>
						  </div>
						  <div class="panel-body">
						  		  <?php  
						  			  require_once CORE.'/DoctorDao.php';
						  			  $ddao = new DoctorDao();
						  			  $res = $ddao->getDoctorDetils($_SESSION['user_id']);
						  		    ?>
						  				<table style="">
						  					<tr>
						  						  ...
						  						  <div class="panel-body">
						  								<form action="book_appointment.php" method="POST" class="form-horizontal" role="form">
						  									<div class="form-group">
						  									    ...
						  									    <div class="col-xs-9">
						  									        <input type="date" name="app_date" id="input" class="form-control" value="" required="required" title="">
						  									    </div>
						  									</div>
						  									<div class="form-group">
						  									    <label for="inputFirstName" class="control-label col-xs-3">Disease : </label>
						  									    <div class="col-xs-9">
						  									        <input type="text" name="disease" id="input" class="form-control" value="" required="required" title=""> 
						  									    </div>
