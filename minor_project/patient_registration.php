...
<link rel="stylesheet" href="css/bootstrap.min.css">
 ...
 <form name='registration' onSubmit="return formValidation();" action = "patient_registration.php" class="form-horizontal" role="form" method="POST">
<div class="content">
		<div class="container">
			...
			<div class="panel panel-primary">
				  ...
				  <div class="panel-body">
						...
						<div class="form-group">
						    ...
						    <div class="col-xs-9">
						        <input type="text" name="lname" id="lname" required="required" class="form-control" placeholder="LastName">
						    </div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						       ...
						       <div class="form-group">
						           <label for="disease" class="control-label col-xs-3">Disease : </label>
						           <div class="col-xs-9">
						               <input type="text" name="disease" required="required" class="form-control" id="disease" placeholder="disease">
						           </div>
						       </div>
						       <div class="form-group">
						       ...
						       <div class="form-group">
						           ...
						           <div class="col-xs-9">
						               <input type="email" name="email" class="form-control" id="email" placeholder="emil id" required="required" >
						           </div>
						       </div>
						       <div class="form-group">
						       ...
						       <div class="form-group">
						           <div class="col-xs-offset-3 col-xs-9">
						               <button name="patient_submit" id="submit" type="submit" class="btn btn-primary">Register</button>
						           </div>
						       </div>
