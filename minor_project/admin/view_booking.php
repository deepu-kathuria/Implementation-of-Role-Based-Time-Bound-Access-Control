	...
	<div class="col-md-6">
					<div class="panel panel-primary">
						  ...
						  <div class="panel-body">
								<form action="view_appointment.php" method="POST" class="form-horizontal" role="form">
									<div class="form-group">
									    <label for="user_id" class="control-label col-md-4">User-id </label>
									    <div class="col-md-4">
									        <input type="text" name="user_id" class="form-control"  required="required" placeholder ="Username" title="">
									    </div>
									</div>
									<div class="form-group">
									    <label for="disease" class="control-label col-md-4">Disease </label>
									    <div class="col-md-4">
									        <input type="text" name="disease" class="form-control"  required="required" placeholder="Disease" title="">
									    </div>
									</div>
									<div class="form-group">
